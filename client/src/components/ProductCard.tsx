...
import { useCart } from "../context/CartContext"; // 1. Agregamos el import correcto (revisa tu ruta exacta si difiere)
...
const ProductCard = ({ product }: Props) => {
    ...
    // 2. Corregido de useCard() a useCart(), y de addToCard a addToCart
