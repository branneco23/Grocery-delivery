...
import deliveryTruckImg from "../../assets/delivery_truck.svg";

const AppPromoBanner = () => {
  return (
    <>
      <section className="group max-w-7xl mx-auto px-6 sm:px-12 py-12 my-14 bg-green-950 rounded-3xl overflow-hidden relative">
